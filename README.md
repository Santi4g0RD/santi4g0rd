...
- <a href="https://github.com/Santi4g0RD/SOC-Analyst-Projects/tree/main/splunk-project/credential-attack-detection">Credential Attack Detection — 4-VLAN Proxmox lab (OPNsense + Splunk + Wazuh EDR + Zeek NSM), Windows SMB and Linux SSH brute force + password spray validated across four independent detection layers; Zeek NTLM wire extraction, spray evasion of brute-force correlation rules, and Suricata blind spots documented</a>
- <a href="https://github.com/Santi4g0RD/SOC-Analyst-Projects/tree/main/splunk-project/ad-privesc-lab">AD Privilege Escalation Lab — Two-hop ACL escalation on live AD domain (soclab.local): BloodHound GenericWrite → targeted Kerberoasting → DCSync → Golden Ticket + four persistence techniques; 12 MITRE techniques validated across Wazuh EDR, Splunk SPL, Suricata, and Zeek NSM with blind spots documented; includes <a href="https://github.com/Santi4g0RD/SOC-Analyst-Projects/blob/main/splunk-project/ad-privesc-lab/INCIDENT-REPORT.md">IR-2026-001</a> — full incident report with detection timeline, root cause analysis, and containment steps</a>
