...
const para = (runs, spaceBefore = 0, spaceAfter = 40) => new Paragraph({
  children: runs,
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        children: [new TextRun({ text: "OT/ICS professional with 15+ years of hands-on building automation experience — SCADA-like controllers, PLC (GCL+), BACnet, BMS — maintaining and troubleshooting critical infrastructure across a live, network-connected campus. Paired with a security engineering skill set (vulnerability management, threat hunting, EDR) as Security Engineer I at LOGN Pacific. Bilingual English/Spanish.", size: 19, font: FONT })],
      ...
      para([
        ...
        new TextRun({ text: "SCADA · PLC Programming & Troubleshooting · GCL+ · BACnet · BMS · HVAC & Electrical Infrastructure · IEC 62443 · NIST 800-82 · IT/OT Convergence · Network Segmentation · Purdue Model", size: 19, font: FONT }),
      ], 60, 40),
      para([
      ...
      para([
        ...
        new TextRun({ text: "Incident Response · Access Control · Privileged Access Management · Zero Trust · Change Management", size: 19, font: FONT }),
      ], 0, 80),
      ...
      bullet("15+ years as technical owner of OT/ICS environments across a multi-building campus — maintained and troubleshot GCL+ PLC scripts across SCADA-like controllers and BACnet-connected building systems, resolving logic errors across HVAC, boiler, and electrical infrastructure."),
      bullet("Monitored system integrity across 15+ networked buildings, identified anomalous behavior, and executed configuration changes via BMS client terminal — minimizing operational downtime and unplanned outages."),
      bullet("Applied IEC 62443 and NIST 800-82 principles to IT/OT convergence and network segmentation of campus control systems; administered access control via BMS client terminal using least-privilege and PAM principles."),
